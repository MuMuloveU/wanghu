...
<table width="889" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td width="204" height="286" align="center" valign="top"><table width="180" height="4" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td></td>
      </tr>
    </table>
      <table width="170" height="4" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
      <tr>
        <td bgcolor="#FFFFFF"></td>
      </tr>
    </table><!--#include file="left.asp"--></td>
    <td width="685" align="center" valign="top"><table width="585" height="24" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
	  ...
	  <form action="" method="post" name="myform" onSubmit="return check();">
        ...
        <tr>
          <td height="40" align="right" bgcolor="#E3F8E0" class="12_pxcu">存入金币：</td>
		...
		ondrop		= "return regInput(this,	/^[0-9]*$/,		event.dataTransfer.getData('Text'))">
            <span class="hui_12">金币</span><input name="login" type="hidden" id="login4" value="true"></td>
        </tr>
        <tr>
          <td height="40" colspan="2" bgcolor="#E3F8E0" class="hang">
            
            &nbsp; 存款金额需大于100,000。 <br>  
            &nbsp; 存入保险箱中的金币需要游戏银行密码才能取出,请先确认您是否记得游戏银行密码。
            </td>
        </tr>
        <tr>
