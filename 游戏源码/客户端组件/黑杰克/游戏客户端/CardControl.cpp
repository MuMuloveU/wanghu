...
#define CARD_WIDTH					71								//扑克宽度
#define CARD_HEIGHT					96								//扑克高度
...
{
	BYTE bCardValue = bCardData % 13;
	if (bCardValue == 0) 
	{
		return 12 * CARD_WIDTH;
	}
	return (bCardValue - 1) * CARD_WIDTH;
}
...
{
	if(bCardData % 13 == 0)
		return (bCardData / 13 - 1) * CARD_HEIGHT;
	return bCardData/13*CARD_HEIGHT;
}
