...
Source: "{app}\Land\Locker.bmp"; DestDir: "{app}\Land"; Flags: ignoreversion
Source: "{app}\Land\TableFrame.DAT"; DestDir: "{app}\Land"; Flags: ignoreversion
Source: "{app}\Land\TableNormal.bmp"; DestDir: "{app}\Land"; Flags: ignoreversion
Source: "{app}\Land\TablePlaying.bmp"; DestDir: "{app}\Land"; Flags: ignoreversion
Source: "{app}\Land\UserReady.bmp"; DestDir: "{app}\Land"; Flags: ignoreversion

[Run]
Filename: "{app}\GamePlaza.exe"; Description: "{cm:LaunchProgram,斗地主}";
