...
CGameServiceManager::CGameServiceManager(void)
{
	...
	lstrcpyn(m_GameServiceAttrib.szClientModuleName,TEXT("OddEven.EXE"),CountArray(m_GameServiceAttrib.szClientModuleName));
	lstrcpyn(m_GameServiceAttrib.szServerModuleName,TEXT("OddEvenServer.DLL"),CountArray(m_GameServiceAttrib.szServerModuleName));
