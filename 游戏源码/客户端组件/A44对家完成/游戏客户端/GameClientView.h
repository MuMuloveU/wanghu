...
///////////////////////////////////////////////////////////////////////////////////
#define IDM_SORT_HAND_CHA			(WM_USER+107)						//叉
#define IDM_SORT_HAND_NOCHA			(WM_USER+108)						//不叉
#define IDM_SORT_HAND_DIAN			(WM_USER+109)						//点
#define IDM_SORT_HAND_NODIAN		(WM_USER+110)						//不点

#define IDM_LI_GUN                  (WM_USER+111)                       //立棍
#define IDM_JUE_GUN                 (WM_USER+112)                       //撅棍
#define IDM_AGREE                   (WM_USER+113)                       //同意
#define IDM_NOT_LI_GUN              (WM_USER+114)                       //不立棍
#define IDM_NOT_JUE_GUN             (WM_USER+115)                       //不撅棍
///////////////////////////////////////////////////////////////////////////////////
...
protected:
	...
	CSkinImage						m_Imagetime;						//时间资源
	CSkinImage						m_Imagetimech;						//时间长度
	//按钮控件
public:
...
//////////////////////////////////////////////////////////////////////////////////////////////
//添加 立棍、撅棍、同意、不同意按钮
	CSkinButton						m_btLiGun;					    //立棍按钮
	CSkinButton						m_btJueGun;						//撅棍按钮
	CSkinButton						m_btAgree;						// 同意
	CSkinButton						m_btDisagree;					// 不同意
	CSkinButton                     m_btNotLiGun;                   //不立棍
	CSkinButton                     m_btNotJueGun;                  //不撅棍
///////////////////////////////////////////////////////////////////////////////////////////////
...
//添加按钮响应函数
	//立棍按钮
	afx_msg void OnHitLiGun();
	//撅棍按钮
	afx_msg void OnHitJueGun();
	//同意按钮
	afx_msg void OnHitAgree();
	//不同意按钮
	afx_msg void OnHitDisagree();
	//不立棍按钮
	afx_msg void OnHitNotLiGun();
	//不撅棍按钮
	afx_msg void OnHitNotJueGun();
/////////////////////////////////////////////////////////////////
