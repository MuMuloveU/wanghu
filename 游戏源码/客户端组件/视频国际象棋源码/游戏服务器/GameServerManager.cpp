...
CGameServiceManager::CGameServiceManager(void)
{
	...
	lstrcpyn(m_GameServiceAttrib.szServerModuleName,TEXT("ChessVDServer.DLL"),CountArray(m_GameServiceAttrib.szServerModuleName));
	lstrcpyn(m_GameServiceAttrib.szClientModuleName,TEXT("ChessVD.EXE"),CountArray(m_GameServiceAttrib.szClientModuleName));
