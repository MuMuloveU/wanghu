...
protected:
	...
	BYTE							m_bScoreCard[GAME_PLAYER][12];		//记录玩家分值扑克
	BYTE							m_bScoreCardCount[GAME_PLAYER];//记录玩家分值扑克数
...
protected:
	...
	//选庄
	bool OnSubBank(const void * pBuffer,WORD wDataSize);
	//补牌
	bool OnSubRecruitCard(const void * pBuffer,WORD wDataSize);
