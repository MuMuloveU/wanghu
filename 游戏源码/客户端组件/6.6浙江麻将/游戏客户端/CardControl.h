...
public:
	...
	CCardListImage					m_ImageKingBrotherTop;				//图片资源
	CCardListImage					m_ImageKingBrotherBottom;			//图片资源
	CCardListImage					m_ImageKingBrotherLeft;				//图片资源
	CCardListImage					m_ImageKingBrotherRight;			//图片资源
...
public:
	...
	//设置数据指针
	void SetDataCtrl(IDataCtrl* pDataCtrl){ m_pDataCtrl = pDataCtrl;}
	//设置财神弟弟位置
	void SetKingBrotherCount(WORD wCount) { m_wKingBrotherPos = wCount-1; }
...
public:
	//构造函数
	CCardControl(IDataCtrl* pDataCtrl);
	//析构函数
