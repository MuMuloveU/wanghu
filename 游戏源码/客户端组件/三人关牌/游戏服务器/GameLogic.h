...
public:
	...
	//点数排列
	void SortCardByPoint(BYTE bCardData[],BYTE bCardCount);
	//混乱扑克
...
public:
	...
	//分析扑克
	void AnalysebCardDataByLogicValue(const BYTE bCardData[], BYTE bCardCount, tagAnalyseResult & AnalyseResult);
};
