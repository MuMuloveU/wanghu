========================================================================
    MICROSOFT 基础类库 : ChannelModule 项目概况
========================================================================


应用程序向导已为您创建了此 ChannelModule DLL。此 DLL 不仅
说明了使用 Microsoft 基础类的基础，而且
也是编写 DLL 的起点。

此文件包含组成 ChannelModule DLL
的每个文件的内容摘要。

ChannelModule.vcproj
