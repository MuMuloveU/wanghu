    ...
    <td width="701" valign="top"><table width="699" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="39" valign="bottom" background="images/l_35.jpg"><table width="153" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="153" height="37" align="right" valign="bottom" class="k_16">魅力排行</td>
          </tr>
        </table></td>
      </tr>
      <tr>
        <td height="1198" align="center" valign="top" background="images/l_36.jpg"><br>
          <table width="600" border="0" cellpadding="0" cellspacing="1" bgcolor="#C0E9FF">
            <tr>
              ...
              <td width="200" align="center" bgcolor="#FFFFFF">魅力值</td>
            </tr>
			<%CxGame.DbConn("QPGameUserDB")%>
              <%
				  Set Rs=Conn.Execute("Select top 50 Accounts,userid,charmvalue From AccountsInfo order by charmvalue desc")
				  if not rs.eof then
				  for i = 1 to 50
			  %>
            <tr>
              <td height="24" align="center" bgcolor="#FFFFFF"><span class="hui"><%=i%></span></td>
              <td align="center" bgcolor="#FFFFFF"><span class="hui"><%=rs(0)%></span></td>
              <td align="center" bgcolor="#FFFFFF"><span class="hui"><%=rs("charmvalue")%></span></td>
            </tr>
			<%
			  rs.movenext
