...
CGameServiceManager::CGameServiceManager(void)
{
	...
	lstrcpyn(m_GameServiceAttrib.szDescription,TEXT("两副斗地主游戏服务组件"),CountArray(m_GameServiceAttrib.szDescription));
	m_GameServiceAttrib.cbJoinInGame = FALSE;

#ifdef VIDEO_GAME
	lstrcpyn(m_GameServiceAttrib.szDataBaseName,TEXT( "QPLandEXVDDB" ),CountArray(m_GameServiceAttrib.szDataBaseName));	
	lstrcpyn(m_GameServiceAttrib.szClientModuleName,TEXT("LandEXVD.EXE"),CountArray(m_GameServiceAttrib.szClientModuleName));
	lstrcpyn(m_GameServiceAttrib.szServerModuleName,TEXT("LandEXVDServer.DLL"),CountArray(m_GameServiceAttrib.szServerModuleName));
#else
	lstrcpyn(m_GameServiceAttrib.szDataBaseName,TEXT( "QPLandDB" ),CountArray(m_GameServiceAttrib.szDataBaseName));	
	lstrcpyn(m_GameServiceAttrib.szClientModuleName,TEXT("LandEX.EXE"),CountArray(m_GameServiceAttrib.szClientModuleName));
	lstrcpyn(m_GameServiceAttrib.szServerModuleName,TEXT("LandEXServer.DLL"),CountArray(m_GameServiceAttrib.szServerModuleName));
#endif
