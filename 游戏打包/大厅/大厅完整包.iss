...
[Files]
Source: "D:\fox66\演示打包\游戏\{app}\gameplaza.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\fox66\演示打包\游戏\{app}\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
[Icons]
Name: "{group}\网狐6.6测试"; Filename: "{app}\gameplaza.exe"
Name: "{commondesktop}\网狐6.6测试"; Filename: "{app}\gameplaza.exe"; Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\网狐6.6测试"; Filename: "{app}\gameplaza.exe"; Tasks: quicklaunchicon
Name: "{group}\{cm:UninstallProgram,视频棋牌}"; Filename: "{uninstallexe}";


[Run]
Filename: "{app}\gameplaza.exe"; Description: "{cm:LaunchProgram,网狐6.6测试}"; Flags: nowait postinstall skipifsilent
