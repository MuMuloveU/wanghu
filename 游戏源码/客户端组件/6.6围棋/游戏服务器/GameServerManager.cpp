...
CGameServiceManager::CGameServiceManager(void)
{
	...
	lstrcpyn(m_GameServiceAttrib.szDataBaseName,TEXT("QPWeiQiDB"),CountArray(m_GameServiceAttrib.szDataBaseName));
	lstrcpyn(m_GameServiceAttrib.szDescription,TEXT("围棋游戏服务组件"),CountArray(m_GameServiceAttrib.szDescription));
