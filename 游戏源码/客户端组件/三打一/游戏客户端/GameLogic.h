...
public:
	tagOneCardNum(){}
	tagOneCardNum(BYTE bCardLogicValue, BYTE bCardNum){
		m_bCardLogicValue = bCardLogicValue;
		m_bCardNum = bCardNum;
	}
	union {
	BYTE m_bCardLogicValue;
	BYTE m_bStartIndex;
	};
	BYTE m_bCardNum;
	/*tagOneCardNum & operator = (tagOneCardNum & b)
	{	
		if(this == &b) return *this;
		m_bCardLogicValue = b.m_bCardLogicValue;
		m_bCardNum = b.m_bCardNum;
		return *this;
	}*/
};
//////////////////////////////////////////////////////////////////////////
...
protected:
	...
	CArrayTemplate<tagOneCardNum>	m_atCardNumList;					//扑克列表及其张数
...
public:
	...
	//排列扑克
	void SortCardList(BYTE bCardData[], BYTE bCardCount,bool bLargeToSmall=true);
	//按牌数排列扑克
	void SortCardByNum(BYTE bCardData[], BYTE bCardCount, bool bMoreToLess=true);
};
