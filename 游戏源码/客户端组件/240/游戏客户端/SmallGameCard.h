...
#define		HEIGHT_CARD_SMALL		21
#define		WIDTH_CARD_SMALL		15


//
//扑克类
//
class  CSmallGameCard : public CWnd
{
	//枚举定义
public:
...
public:
	...
	//获取扑克数值
	inline BYTE GetCardValoe(BYTE bCard) { BYTE bkk=(bCard&UG_VALUE_MASK)+1;
		if (bkk==14) bkk=1;
		return bkk; }
	//获取扑克花色
