...
CGameServiceManager::CGameServiceManager(void)
{
	...
	lstrcpyn(m_GameServiceAttrib.szClientModuleName,TEXT("SX_Trench.EXE"),CountArray(m_GameServiceAttrib.szClientModuleName));
	lstrcpyn(m_GameServiceAttrib.szServerModuleName,TEXT("SX_TrenchServer.DLL"),CountArray(m_GameServiceAttrib.szServerModuleName));
